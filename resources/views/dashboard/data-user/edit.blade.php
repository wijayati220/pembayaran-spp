...
@section('content')
	...
	<div class="row">
         <div class="col-md-12">
              <div class="card">
                  <div class="card-body">
                       <div class="card-title">{{ __('Tambah user') }}</div>
                     
                        <form method="post" action="{{ url('dashboard/data-user', $edit->id) }}" id="edit_data">
                        ...
                        <select name="level" class="custom-select @error('level') is-invalid @enderror">							
                              ...
                              <option value="wali murid" {{ $edit->level == 'wali murid' ? 'selected' : '' }}>wali murid</option>
                              <option value="siswa" {{ $edit->level == 'siswa' ? 'selected' : '' }}>siswa</option>
                              <option value="kepala sekolah" {{ $edit->level == 'kepala sekolah' ? 'selected' : '' }}>kepala sekolah</option>
                       </select>
                     </div>
                     <span class="text-danger">@error('level') {{ $message }} @enderror</span>
                           ...
                           <a href="{{ url('dashboard/data-user') }}" class="btn btn-primary btn-rounded">
